...
btnx=Button(row1,text="x",borderwidth=0,relief=FLAT,font=("verdana",11))
btnx.pack(side=LEFT,expand= True,fill="both")

btn9=Button(row1,text="sin",borderwidth=0,relief=FLAT,font=("verdana",11))
btn9.pack(side=LEFT,expand= True,fill="both")

btnx=Button(row1,text="rad",borderwidth=0,relief=FLAT,font=("verdana",11))
btnx.pack(side=LEFT,expand= True,fill="both")
...
btni=Button(row2,text="-",borderwidth=0,relief=FLAT,font=("verdana",11))
btni.pack(side=LEFT,expand= True,fill="both")

btn6=Button(row2,text="cos",borderwidth=0,relief=FLAT,font=("verdana",11))
btn6.pack(side=LEFT,expand= True,fill="both")

btni=Button(row2,text="deg",borderwidth=0,relief=FLAT,font=("verdana",11))
btni.pack(side=LEFT,expand= True,fill="both")
...
btnp=Button(row3,text="+  ",borderwidth=0,relief=FLAT,font=("verdana",11))
btnp.pack(side=LEFT,expand= True,fill="both")

btn6=Button(row3,text="tan  ",borderwidth=0,relief=FLAT,font=("verdana",11))
btn6.pack(side=LEFT,expand= True,fill="both")

btni=Button(row3,text="n!",borderwidth=0,relief=FLAT,font=("verdana",11))
btni.pack(side=LEFT,expand= True,fill="both")



btnd=Button(row4,text="/",borderwidth=0,relief=FLAT,font=("verdana",11))
...
btndo=Button(row4,text=".",borderwidth=0,relief=FLAT,font=("verdana",11))
btndo.pack(side=LEFT,expand= True,fill="both")

btneq=Button(row4,text="  =",borderwidth=0,relief=FLAT,font=("verdana",22))
btneq.pack(side=LEFT,expand= True,fill="both")

btn6=Button(row4,text="log  ",borderwidth=0,relief=FLAT,font=("verdana",11))
btn6.pack(side=LEFT,expand= True,fill="both")

btni=Button(row4,text="e",borderwidth=0,relief=FLAT,font=("verdana",11))
btni.pack(side=LEFT,expand= True,fill="both")



btn22=Button(row5,text="x^2",borderwidth=0,relief=FLAT,font=("verdana",11))
btn22.pack(side=LEFT,expand= True,fill="both")

btn33=Button(row5,text="x^3",borderwidth=0,relief=FLAT,font=("verdana",11))
btn33.pack(side=LEFT,expand= True,fill="both")

btnsq=Button(row5,text="C",borderwidth=0,relief=FLAT,font=("verdana",11))
btnsq.pack(side=LEFT,expand= True,fill="both")

btnpr=Button(row5,text="%",borderwidth=0,relief=FLAT,font=("verdana",11))
btnpr.pack(side=LEFT,expand= True,fill="both")

btnsq=Button(row5,text="  x^y",borderwidth=0,relief=FLAT,font=("verdana",11))
btnsq.pack(side=LEFT,expand= True,fill="both")

btnpr=Button(row5,text="mod",borderwidth=0,relief=FLAT,font=("verdana",11))
btnpr.pack(side=LEFT,expand= True,fill="both")
