...
btni.pack(side=LEFT,expand= True,fill="both")
btnd=Button(row4,text="/",borderwidth=0,relief=FLAT,bg="#c0c0c0",font=("verdana",11),command=btndiv)
...
btni.pack(side=LEFT,expand= True,fill="both")
btn22=Button(row5,text="x2",borderwidth=0,bg="#c0c0c0",relief=FLAT,font=("verdana",11))
btn22.pack(side=LEFT,expand= True,fill="both")
btn33=Button(row5,text="x3",borderwidth=0,bg="#c0c0c0",relief=FLAT,font=("verdana",11))
